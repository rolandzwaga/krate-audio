...
// ==============================================================================
// ColorUtils - Shared Color Manipulation Utilities
// ==============================================================================
// Extracted from ArcKnob and FieldsetContainer to eliminate ODR duplication.
// Used by: ArcKnob, FieldsetContainer, StepPatternEditor, and future views.
//
// All functions are inline free functions in Krate::Plugins namespace.
// ==============================================================================
