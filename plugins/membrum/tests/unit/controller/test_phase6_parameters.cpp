...
TEST_CASE("Phase 6 global parameter IDs are allocated correctly", "[phase6_params]")
{
    ...
    SECTION("kCurrentStateVersion bumped to 12 (Phase 8F per-pad enable)")
    {
        STATIC_REQUIRE(kCurrentStateVersion == 12);
    }
}
...
TEST_CASE("padOffsetFromParamId accepts macro offsets 37-41", "[phase6_params]")
{
    ...
    SECTION("Offsets 52-53 are active Phase 8C air-loading / scatter fields")
    {
    ...
    SECTION("Offsets 54-57 are active Phase 8D coupling + secondary fields")
    {
    ...
    SECTION("Offset 59 is now active (Phase 8F per-pad enable)")
    {
