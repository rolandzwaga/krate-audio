...
using SingleParamQueueST = Krate::Test::ParamValueQueue;
using MultiParamChangesST = Krate::Test::ParameterChanges;
          ...
          "[coupling][phase6][preset]")
{
    ...
    // Verify blob size is exactly 460 bytes (Phase 10: version 4 + 2 * int32 + 56 *
