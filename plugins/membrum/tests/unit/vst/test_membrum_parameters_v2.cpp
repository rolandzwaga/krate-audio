...
constexpr int kExpectedParameterCount = 1388;  // Phase 2 (34) + Phase 3 (3) + Phase 4 (1 + 1152) + Phase 5 (4) + Phase 6 US4 (32 per-pad coupling amounts) + Phase 6 US1 (2 session-scoped globals + 32*5 macros = 162)
