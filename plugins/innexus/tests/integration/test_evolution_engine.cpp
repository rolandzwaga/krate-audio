...
using EvoTestEventList = Krate::Test::EventListNoteIdEqPitch;


// Minimal parameter value queue
// Parameter-change mocks consolidated into tests/test_helpers/vst_param_changes.h
using EvoTestParamValueQueue = Krate::Test::ParamValueQueue;
using EvoTestParameterChanges = Krate::Test::ParameterChanges;
