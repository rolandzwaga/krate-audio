...
using NoiseTestEventList = Krate::Test::EventListNoteIdEqPitch;


// Parameter-change mocks consolidated into tests/test_helpers/vst_param_changes.h
using NoiseTestParamValueQueue = Krate::Test::ParamValueQueue;
using NoiseTestParameterChanges = Krate::Test::ParameterChanges;
