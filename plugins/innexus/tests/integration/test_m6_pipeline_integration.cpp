...
using PipelineTestEventList = Krate::Test::EventListNoteIdEqPitch;


// Minimal parameter value queue
// Parameter-change mocks consolidated into tests/test_helpers/vst_param_changes.h
using PipelineTestParamValueQueue = Krate::Test::ParamValueQueue;
using PipelineTestParameterChanges = Krate::Test::ParameterChanges;
