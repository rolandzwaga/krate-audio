...
using M5TestEventList = Krate::Test::EventListNoteIdEqPitch;


// Minimal parameter value queue
// Parameter-change mocks consolidated into tests/test_helpers/vst_param_changes.h
using M5TestParamValueQueue = Krate::Test::ParamValueQueue;
using M5TestParameterChanges = Krate::Test::ParameterChanges;
