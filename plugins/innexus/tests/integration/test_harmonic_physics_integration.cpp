...
using PhysicsTestEventList = Krate::Test::EventListNoteIdEqPitch;


// Minimal parameter value queue
// Parameter-change mocks consolidated into tests/test_helpers/vst_param_changes.h
using PhysicsTestParamValueQueue = Krate::Test::ParamValueQueue;
using PhysicsTestParameterChanges = Krate::Test::ParameterChanges;
