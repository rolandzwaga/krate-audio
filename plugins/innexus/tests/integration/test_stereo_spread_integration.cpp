...
using StereoTestEventList = Krate::Test::EventListNoteIdEqPitch;


// Minimal parameter value queue
// Parameter-change mocks consolidated into tests/test_helpers/vst_param_changes.h
using StereoTestParamValueQueue = Krate::Test::ParamValueQueue;
using StereoTestParameterChanges = Krate::Test::ParameterChanges;
