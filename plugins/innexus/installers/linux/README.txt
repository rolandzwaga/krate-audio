================================================================================
                       INNEXUS VST3 INSTRUMENT PLUGIN
                           Installation Guide
================================================================================

Thank you for downloading Innexus, a harmonic analysis and resynthesis
instrument plugin by Krate Audio.
...
System-Wide Installation:
   ...
   sudo cp -r Innexus.vst3 /usr/lib/vst3/
...
User Installation (Recommended):
   ...
   mkdir -p ~/Documents/Krate\ Audio/Innexus
   cp -r presets/* ~/Documents/Krate\ Audio/Innexus/

System-Wide Installation:
   For all users on the system:

   sudo mkdir -p /usr/share/krate-audio/innexus
   sudo cp -r presets/* /usr/share/krate-audio/innexus/
...
3. Look for "Innexus" in your plugin list under Instruments


SUPPORTED DAWs
--------------

Innexus has been tested with the following Linux DAWs:
