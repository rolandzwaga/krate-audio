; Disrumpo VST3 Plugin Installer
; Inno Setup Script
;
; This script is compiled by the release workflow using Inno Setup
; to create a Windows installer for the Disrumpo VST3 plugin.

#define AppName "Disrumpo"
...
[Setup]
; Unique application ID (GUID) - generated for Disrumpo
AppId={{A3E9B7D1-6F2C-4A8E-B5D4-7C1E9F3A2B8D}
AppName={#AppName}
AppVersion={#Version}
...
DefaultDirName={commonpf}\Common Files\VST3\Krate Audio\Disrumpo
; No user-selectable program group needed for a plugin
DisableProgramGroupPage=yes

; Output file naming
OutputDir=.
OutputBaseFilename=Disrumpo-{#Version}-Windows-x64
...
[Files]
; Copy the entire Disrumpo.vst3 bundle recursively
; Source path is relative to where the workflow runs (artifact extraction location)
Source: "Disrumpo.vst3\*"; DestDir: "{app}\Disrumpo.vst3"; Flags: ignoreversion recursesubdirs createallsubdirs
; Install changelog with the plugin
Source: "CHANGELOG.txt"; DestDir: "{app}\Disrumpo.vst3"; Flags: ignoreversion
; Factory presets - install to system-wide presets location
; {commonappdata} = C:\ProgramData on modern Windows
Source: "presets\*"; DestDir: "{commonappdata}\Krate Audio\Disrumpo"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Type: filesandordirs; Name: "{app}\Disrumpo.vst3"
