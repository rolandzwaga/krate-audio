...
using SingleParamQueue = Krate::Test::ParamValueQueue;
using ParamChangeBatch = Krate::Test::ParameterChanges;
...
TEST_CASE("Arp state round-trip preserves Euclidean settings",
    ...
    constexpr size_t kArpSectionSize = 1192; // 1160 base + 32 bytes (8 lane speed floats)
