...
using E2EEventList = Krate::Test::EventList;
...
using E2EParamQueue = Krate::Test::ParamValueQueue;
using E2EParamChanges = Krate::Test::ParameterChanges;
using E2EEmptyParamChanges = Krate::Test::ParameterChanges;
