; Vorago VST3 Plugin Installer
; Inno Setup Script
;
; This script is compiled by the release workflow using Inno Setup
; to create a Windows installer for the Vorago VST3 plugin.

#define AppName "Vorago"
...
[Setup]
; Unique application ID (GUID) - generated for Vorago
AppId={{5716199F-E321-435B-A60E-4F7AFAA1ADBD}
AppName={#AppName}
AppVersion={#Version}
...
DefaultDirName={commonpf}\Common Files\VST3\Krate Audio\Vorago
; No user-selectable program group needed for a plugin
DisableProgramGroupPage=yes

; Output file naming
OutputDir=.
OutputBaseFilename=Vorago-{#Version}-Windows-x64
...
[Files]
; Copy the entire Vorago.vst3 bundle recursively
; Source path is relative to where the workflow runs (artifact extraction location)
Source: "Vorago.vst3\*"; DestDir: "{app}\Vorago.vst3"; Flags: ignoreversion recursesubdirs createallsubdirs
; Install changelog with the plugin
Source: "CHANGELOG.txt"; DestDir: "{app}\Vorago.vst3"; Flags: ignoreversion
; Factory presets - install to system-wide presets location
; {commonappdata} = C:\ProgramData on modern Windows
Source: "presets\*"; DestDir: "{commonappdata}\Krate Audio\Vorago"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Type: filesandordirs; Name: "{app}\Vorago.vst3"
