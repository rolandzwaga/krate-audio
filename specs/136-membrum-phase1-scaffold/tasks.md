...
- [X] T006 [P] Create `plugins/membrum/resources/auv3/audiounitconfig.h` with `kSupportedNumChannels` = `02` (0 in / 2 out) per FR-006 and AU wrapper lessons. (NOTE: `0022` is WRONG — it parses as (0,0)+(2,2), not "0 in / 2 out", and fails AU init; use `02`.)
