// ==============================================================================
// API Contract: ArpLane<T, MaxSteps> (Layer 1 Primitive)
// ==============================================================================
// Spec: 072-independent-lanes
// Location: dsp/include/krate/dsp/primitives/arp_lane.h
//
// Generic fixed-capacity step lane container for arpeggiator polymetric
// patterns. Each lane maintains an independent step position that advances
// and wraps at its own configured length.
//
