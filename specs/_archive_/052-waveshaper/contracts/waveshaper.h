// ==============================================================================
// Layer 1: DSP Primitive - Waveshaper (API Contract)
// ==============================================================================
...
private:
    ...
    WaveshapeType type_;  ///< Selected waveshape algorithm
    float drive_;         ///< Pre-gain multiplier (>= 0.0)
    float asymmetry_;     ///< DC bias for asymmetry [-1.0, 1.0]
};
