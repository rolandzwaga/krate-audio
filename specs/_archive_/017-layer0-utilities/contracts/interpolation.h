...
// ==============================================================================
// API CONTRACT - Standalone interpolation utilities for sample-domain operations.
//
