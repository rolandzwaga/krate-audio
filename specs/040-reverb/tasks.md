...
- [X] T017 [US1] Implement `Reverb::setParams(const ReverbParams&)` method to update all 9 smoothers with parameter values in `dsp/include/krate/dsp/effects/reverb.h`
