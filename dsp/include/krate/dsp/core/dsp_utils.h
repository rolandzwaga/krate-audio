...
// ==============================================================================
// Gain Utilities - Use Krate::DSP (core/db_utils.h)
// ==============================================================================
// dB/linear conversion functions are in src/dsp/core/db_utils.h:
//   - Krate::DSP::dbToGain(float dB) -> linear gain
//   - Krate::DSP::gainToDb(float gain) -> dB value
//   - Krate::DSP::kSilenceFloorDb -> -144 dB floor (24-bit dynamic range)
...
// Use #include <krate/dsp/primitives/smoother.h> for the full implementation.
