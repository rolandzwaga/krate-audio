...
// ==============================================================================
// Document behavioral differences between old VSTWork::DSP and new Krate::DSP
...
TEST_CASE("Migration: namespace changed from VSTWork to Iterum", "[dsp][core][db_utils][migration]") {
    ...
    SECTION("New functions are in Krate::DSP namespace") {
        // Using fully qualified names to verify namespace
        float gain = Krate::DSP::dbToGain(-6.0f);
        float dB = Krate::DSP::gainToDb(0.5f);
