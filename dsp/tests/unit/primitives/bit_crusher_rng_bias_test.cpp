...
TEST_CASE("BitCrusher RNG has zero mean over long runs", "[primitives][bit-crusher][rng][bias][long]") {
    ...
    float mean_0_10 = static_cast<float>(sum_0_10 / 10.0);
    float mean_100_110 = static_cast<float>(sum_100_110 / 10.0);
    float mean_500_510 = static_cast<float>(sum_500_510 / 10.0);
    float mean_1000_1010 = static_cast<float>(sum_1000_1010 / 10.0);
