...
// ==============================================================================
// VST3 host mock infrastructure for fixture generation
// ==============================================================================
// All VST3-SDK-only types; safe to include from either the Gradus or the
// Ruinae generator translation unit.
// ==============================================================================
...
class FixtureEventList : public Steinberg::Vst::IEventList {
public:
...
class FixtureParamQueue : public Steinberg::Vst::IParamValueQueue {
public:
    FixtureParamQueue(Steinberg::Vst::ParamID id, double value)
...
class FixtureParamChanges : public Steinberg::Vst::IParameterChanges {
public:
    Steinberg::tresult PLUGIN_API queryInterface(const Steinberg::TUID, void**) override {
        return Steinberg::kNoInterface;
    }
...
private:
    std::vector<FixtureParamQueue> queues_;
};

class FixtureEmptyParamChanges : public Steinberg::Vst::IParameterChanges {
public:
    Steinberg::tresult PLUGIN_API queryInterface(const Steinberg::TUID, void**) override {
        return Steinberg::kNoInterface;
    }
