...
| 9 | Iterum `formatXxxParam` snprintf display helpers | intra-area:iterum | 170 | low | ⬜ |
...
**`version.h.in` + `win32resource.rc.in` templates** (rank 7, ~320 net combined)
...
**OutlineButton CView base + button subclasses** (rank 6, ~300 net)
